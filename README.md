...
<p aligh="center">Multiple customers (green dots) enter the retail store (10x8 rectangle box) at the entry point and leave through the exit zone. (Entry point: seafoam green; Exit zone: pale pink) </p>
