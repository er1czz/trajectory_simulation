...
- Data synthesis: ```python app.py``` and follow the instructions to enter number of customers and output file name (example [sample_output.csv](https://github.com/er1czz/trajectory_simulation/blob/main/sample_output.csv))
